...
import {BraintreeModule, BraintreeWebhookController, BraintreeWebhookModule} from './..';
...
describe('BraintreeWebhookController', () => {
  ...
  it('Webhook controller must instance', () => {
    const controller = module.get<BraintreeWebhookController>(BraintreeWebhookController);
